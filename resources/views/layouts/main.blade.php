...
<body>
    ...
    <script src="assets/template/mazer/dist/assets/static/js/pages/sweetalert2.js"></script>

    {{-- Simple Datatable --}}
    <script src="assets/template/mazer/dist/assets/extensions/simple-datatables/umd/simple-datatables.js"></script>
    <script src="assets/template/mazer/dist/assets/static/js/pages/simple-datatables.js"></script>

    {{-- jQuery --}}
    <script src="assets/assets/js/jquery/jquery-3.7.1.min.js"></script>

    {{-- Flatpickr --}}
    <script src="assets/template/mazer/dist/assets/extensions/flatpickr/flatpickr.min.js"></script>
    <script src="assets/template/mazer/dist/assets/static/js/pages/date-picker.js"></script>
